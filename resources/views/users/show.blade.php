<x-app-layout>
    <div class="w-1/2 mx-auto mt-5 bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
        <h2 class="text-1xl">User Information</h2>
        <div class="mt-5">
            <p class="text-md">Fullname: {{ $user->name }}</p>
            <p class="text-md">Email Address: {{ $user->email }}</p>
            <p class="text-md">Password: {{ $user->password }}</p>
