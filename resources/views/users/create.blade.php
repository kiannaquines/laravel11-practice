    ...
    <div class="w-1/2 mx-auto mt-5">
        ...
        <form action="{{ route('users.store') }}" method="POST" class="mt-5">
            ...
            <div class="flex gap-2">
                <input type="submit" value="Create User" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-pointer">
